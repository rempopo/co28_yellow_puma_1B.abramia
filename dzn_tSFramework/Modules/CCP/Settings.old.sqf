dzn_tsf_CCP_HealTime		= 5*60; // 10 mins to heal player
dzn_tsf_CCP_Radius		= 25; 	// 25 m 
dzn_tsf_CCP_PreventPlayerDeath	= false; // Once on CCP - player will not die until healed
dzn_tsf_CCP_DefaultComposition	= "US Woodland Humvee";	// Name of default composition; See 'DefaultCompositions.sqf' for names
